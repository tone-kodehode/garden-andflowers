...
export const PlantersProductCard = ({id, onClick, imageUrl, alt, title, shortDescription, price, currency}) => {
  return (
    <section className={ProductCardsStyles.cardContainer} onClick={() => onClick(id)}>
      <div className={ProductCardsStyles.productCard} id={id}>
        <section className={ProductCardsStyles.imgSection}>
...
export const UtilitiesProductCard = ({id, onClick, imageUrl, alt, title, shortDescription, price, currency}) => {
  return (
    <section className={ProductCardsStyles.cardContainer} onClick={() => onClick(id)}>
      <div className={ProductCardsStyles.productCard} id={id}>
        <section className={ProductCardsStyles.imgSection}>
