  ...
  return (
    <div className={CreateAccountStyles.container}>
      <div className={CreateAccountStyles.formContainer}>
          <h1 className={CreateAccountStyles.title}>
            Create An Account
          </h1>
          ...
          >
              <input 
                className={CreateAccountStyles.input} 
                type="text" 
                placeholder="Name"
              />
              <input 
              ...
              <input className={CreateAccountStyles.input} 
                type="text" 
              ...
              <button 
                className={CreateAccountStyles.registerButton}> 
                Create
              </button>
          </form>
      </div>
